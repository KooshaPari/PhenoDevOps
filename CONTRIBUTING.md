# Contributing to PhenoDevOps

Thanks for your interest in contributing to **PhenoDevOps**, part of the [Phenotype](https://github.com/KooshaPari) ecosystem.
...
```bash
git clone https://github.com/KooshaPari/PhenoDevOps.git
cd PhenoDevOps
